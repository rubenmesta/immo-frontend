...
class Chatbot extends Component {
    ...
    async df_text_query (queryText) {
        ...
        const res = await axios.post('/cors-proxy/https://harvard-capstone.herokuapp.com/api/df_text_query',  {text: queryText, userID: cookies.get('userID')});
    ...
    async df_event_query(eventName) {
        ...
        const res = await axios.post('/cors-proxy/https://harvard-capstone.herokuapp.com/api/df_event_query',   {event: eventName, userID: cookies.get('userID')});
